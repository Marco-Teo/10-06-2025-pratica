...
public class AppConfig {
    ...
    public Cloudinary getCloudinary(@Value("${cloudinary.cloud_name}") String cloudName,
                                    ...
                                    @Value("${cloudinary.api_secret}") String apiSecre){
        ...
        configCloudinary.put("api_secret", apiSecre);

        return new Cloudinary(configCloudinary);
    }

    // questo serve per entrare e mandare le email
    @Bean
